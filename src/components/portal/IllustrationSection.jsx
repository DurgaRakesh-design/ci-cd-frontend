          ...
          <div className="relative grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-500 mt-4 leading-relaxed max-w-md">
                Our CI/CD platform handles the entire lifecycle — from code upload to production
                deployment — with built-in security scans, automated testing, and real-time monitoring.
              </p>
